...
file(GLOB_RECURSE IMPL_HEADERS "${CURRENT_PACKAGES_DIR}/include/imgui_impl**.h")

foreach(IMPL ${IMPL_HEADERS})
    vcpkg_replace_string(${IMPL} "IMGUI_API" "")
    vcpkg_replace_string(${IMPL} "IMGUI_IMPL_API" "")
endforeach ()
